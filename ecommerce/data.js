var data = [
  {
    ...
    price: "69000",
    priceoff: "89,000",
    rating: "8/10(26 Reviews)",
    offerdetils: "10% extra discount in icici card",
    view: "View details",
    button: "Add to cart",
    Categories: "topdeals",
  },
...
function display(data) {
  ...
  data.map((el) => {
    ...
    buttondeals1text.innerText = el.button;
    buttondeals1text.setAttribute("class", "buttondeals1text");
    buttondeals1text.addEventListener("click", () => {
      addtocart(el);
    });

    deals1subdetlis2.append(deals1viewdetails, buttondeals1text);
    deals1detlis.append(
      text1deals,
      deals1subdetlis1,
      reviews,
